// IronSynk — Complete Exercise Seed v2
// Run with: npx tsx prisma/seeds/exercises-seed.ts
// ~400+ exercises organized by muscle group
...
const exercises: ExerciseInput[] = [
  ...
  { name: 'Crossover Alto Sentado no Cabo', muscleGroup: 'CHEST', equipment: 'cable', sourceId: 'seated-cable-fly-high' },
  { name: 'Crossover Baixo Sentado no Cabo', muscleGroup: 'CHEST', equipment: 'cable', sourceId: 'seated-cable-fly-low' },
  ...
  { name: 'Pullover no Cabo', muscleGroup: 'CHEST', equipment: 'cable', sourceId: 'cable-pullover' },
  ...
  { name: 'Remada Curvada com Barra', muscleGroup: 'BACK', equipment: 'barbell', sourceId: 'barbell-bent-over-row' },
  { name: 'Remada Curvada Pronada', muscleGroup: 'BACK', equipment: 'barbell', sourceId: 'pronated-barbell-row' },
  ...
  { name: 'Pullover com Halter (Costas)', muscleGroup: 'BACK', equipment: 'dumbbell', sourceId: 'dumbbell-pullover-back' },
  ...
  { name: 'Levantamento Terra Convencional', muscleGroup: 'BACK', equipment: 'barbell', sourceId: 'conventional-deadlift' },
  ...
  { name: 'Elevação Lateral Apoiado no Banco', muscleGroup: 'SHOULDERS', equipment: 'dumbbell', sourceId: 'incline-lateral-raise' },
  ...
  { name: 'Rosca na Polia (Barra)', muscleGroup: 'BICEPS', equipment: 'cable', sourceId: 'cable-curl-bar' },
  ...
  { name: 'Agachamento Frontal', muscleGroup: 'QUADS', equipment: 'barbell', sourceId: 'front-squat' },
  { name: 'Agachamento Búlgaro', muscleGroup: 'QUADS', equipment: 'dumbbell', sourceId: 'bulgarian-split-squat' },
  ...
  { name: 'Afundo Lateral', muscleGroup: 'QUADS', equipment: 'dumbbell', sourceId: 'lateral-lunge' },
  ...
  { name: 'RDL Unilateral', muscleGroup: 'HAMSTRINGS', equipment: 'dumbbell', sourceId: 'single-leg-rdl' },
  ...
  // ─────────────────────────────────────────────
  { name: 'Levantamento Terra Convencional', muscleGroup: 'FULL_BODY', equipment: 'barbell', sourceId: 'conventional-deadlift' },
  { name: 'Levantamento Terra Sumô (Composto)', muscleGroup: 'FULL_BODY', equipment: 'barbell', sourceId: 'sumo-deadlift-full-body' },
...
async function main() {
  ...
  console.log('\n📌 Próximo passo:')
  console.log('   Execute o script de download de GIFs do ExerciseDB')
  console.log('   e suba em Supabase Storage > exercises/{sourceId}.gif')
}
